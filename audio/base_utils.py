...
def extract_tagpy(fname):
	'''extraccion de metadata de audio con tagpy'''
...
################################
# Excepciones relacionadas con el proceso de extraccion de directorio
################################
...
class Ignored(Exception):
	pass
#####################################
# auxiliar para el proceso de extraccion basado en mutagen
#####################################
...
#####################################
# proceso de extraccion usando mutagen
######################################
...
###############################
# PROCESO GENERICO DE EXTRACCION EN UN ARBOL
# DE DIRECTORIOS
################################
def load(dir):
